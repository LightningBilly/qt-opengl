...
void Widget::initializeGL() {
    ...
    texture2 = new QOpenGLTexture(QImage("D:/selfad/LearnOpenGL/resources/textures/awesomeface.png").mirrored(true, true));
...
void Widget::paintGL()
{
   // cout<<"paint GL"<<endl;
    ...
    shader->use();
    QMatrix4x4 qm;
    qm.translate(0.5, 0.5, 0.5);
    qm.rotate(time.elapsed()/10, 0,0,1);
    //qm.scale(1.5);
    shader->setMat4("transform", qm);
    ...
    qm.setToIdentity();
    qm.translate(-0.5, -0.5, -0.5);
    qm.rotate(-time.elapsed()/2, 0,0,1);
