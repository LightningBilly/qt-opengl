...
void Widget::initializeGL() {
    ...
    core->glBufferData(GL_ARRAY_BUFFER, sizeof (texCoords), texCoords, GL_STATIC_DRAW);

    core->glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, 2*sizeof (GLfloat), (void*)0);
    ...
    shader->shaderProgram.setUniformValue(shader->shaderProgram.uniformLocation("texture1"),0);
